...
public class CriarProfessorActivity extends AppCompatActivity {
    ...
    private ArrayAdapter<Department> arrayAdapterSpinner;
    private Department department;
    private Professor editarProfessor;
    ...
    private void listaDepartamento(){
        departamentoRepositorio.listarDepartamento(new RespositorioCallBack<List<Department>>() {
            ...
            public void onResponse(List<Department> response) {
                ...
                if(idProfessor > -1){
                    int posicaoDepartamento =arrayAdapterSpinner.getPosition(editarProfessor.getDepartment());
                    binding.departamentosSpinner.setSelection(posicaoDepartamento);
                }
    ...
    private void configuraSpinner(){
        arrayAdapterSpinner = new ArrayAdapter<Department>(this, android.R.layout.simple_list_item_1 );
        ...
        binding.departamentosSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
                department = (Department) binding.departamentosSpinner.getItemAtPosition(position);
                Log.d("spinnerprofessor", "onItemSelected: deu certo"+ department);
            }
